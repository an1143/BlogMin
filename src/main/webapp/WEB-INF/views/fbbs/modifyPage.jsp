      ...
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
              ...
              <form id="bbs_from" role="form" action="/fbbs/modifyPage" class="form-horizontal style-form" method="post">
        ...
        $(document).ready(function(){
        	...
        	$("#bbs_list").on("click",function(){
        	    ...
        	    self.location ="/fbbs/list?page=${fCri.page}&numPerPage=${fCri.numPerPage}findType=${fCri.findType}&keyword=${fCri.keyword}";
